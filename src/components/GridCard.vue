<template>
  <div
    :class="[
      'rounded-[0rem] p-10 md:p-16 flex flex-col items-center text-center overflow-hidden transition-all duration-500 hover:scale-[1.01]',
      bgColor,
      textColor,
    ]"
  >
    <div class="z-10 mb-8">
      <h2 class="text-2xl md:text-3xl xl:text-4xl font-semibold tracking-tight mb-3">
        {{ title }}
      </h2>
      <p class="text-lg md:text-xl xl:text-2xl font-light leading-relaxed opacity-80">
        {{ subtitle }}
      </p>
    </div>
