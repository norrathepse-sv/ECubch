<template>
  <div class="bg-white shadow-lg border border-slate-200 rounded-xl overflow-hidden font-sans">
    <div
      class="bg-slate-50 border-b border-slate-200 px-6 py-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
    >
    ...
    <div class="p-6">
      <div
        ...
        class="text-center py-10 bg-slate-50 rounded-lg border border-dashed border-slate-300 text-slate-500 italic"
      >
      ...
      <div v-else class="flex flex-col gap-3">
        ...
        >
          <div class="flex items-center gap-4 mb-4 sm:mb-0 w-full sm:w-auto overflow-hidden">
            <div
              class="w-12 h-12 bg-teal-100 text-[#004d40] flex items-center justify-center rounded-lg shrink-0"
            >
